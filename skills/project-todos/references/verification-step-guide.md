...
Detailed guidance for Step 7 (Verification) of the agent collaboration workflow. This step has two parts: technical verification (architect) and requirements verification (reviewer). Both must pass before documentation or completion.
